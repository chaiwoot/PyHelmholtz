...
class FDStencil:
    ...
    Attributes:
        nnode (int): number of stencil points
        dv_order (int): derivative order (1 or 2)
        idx_stencil (ndarray): Relative grid indices (e.g., [-1, 0, 1])
        coeff (ndarray): FD coefficients
    """

    def __init__(self, nnode: int, dv_order: int, idx_stencil: list, coeff:list):
        self.nnode = nnode
...
class FDPMLStencil:
    ...
    def __init__(self, nnode: int, dv_order: int, idx_stencil: list, idx_qstencil: list, weight_q: list):
        self.nnode = nnode
        self.dv_order = dv_order
        self.idx_stencil = np.array(idx_stencil, dtype=np.int32)
...
Stencil naming convention:
    stc_[derivative_order][order_accuracy]_[stencil_type]_[points]
    e.g., stc_24_ct_22 = 2nd-order derivative, 4th-order accuracy,
    central stencil with 2 points away from the interested node

"""

# ===================================================================
#  1st-ORDER ACCURACY STENCILS (NON-PML method)
# ===================================================================

# 1st derivative, 1st-order accuracy
...
# ===================================================================
#  2nd-ORDER ACCURACY STENCILS (NON-PML method)
# ===================================================================

# 1st derivative, 2nd-order accuracy
...
# ===================================================================
#  4th-ORDER ACCURACY STENCILS (NON-PML method)
# ===================================================================
...
# ===================================================================
#  2nd-ORDER ACCURACY STENCILS (PML method)
# ===================================================================
...
# ===================================================================
#  4th-ORDER ACCURACY STENCILS (PML method)
# ===================================================================
